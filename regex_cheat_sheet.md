### Regex cheat sheet in Javascript, thanks to [very helpful article.](https://dev.to/catherinecodes/a-regex-cheatsheet-for-all-those-regex-haters-and-lovers--2cj1)
